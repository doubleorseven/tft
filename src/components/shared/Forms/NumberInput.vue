<template>
  <div class="grid grid-cols-1 gap-4 text-center ">
    ...
    <input type="number" :id="inputId" :value="modelValue" :placeholder="placeholder || ''" :min="min" :max="max"
      :step="step" :list="suggestionsId" class="w-full p-3 text-sm border-2 border-gray-200 rounded-lg"
...
const inputId = `number-input-${randomId}`;
